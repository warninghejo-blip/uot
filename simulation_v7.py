...
print(" STARTING SIMULATION V7.1 (News + Grok)...\n")

state = bot.DEFAULT_STATE.copy()

print("--- TEST 1: Smart News Analysis ---")
stats = "BTC: $98k | FB: $0.40"
news_title = "Bitcoin ETF inflows shatter records"
